...
## Project Structure
    ...
    ├── testapiautodatamod_124678  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_124678`
...
2. Clone this repo and `cd testapiautodatamod_124678`
